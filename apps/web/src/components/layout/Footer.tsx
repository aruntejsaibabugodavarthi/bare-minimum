      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="contact-info" style={{ marginTop: '1.5rem', fontSize: '0.9rem', color: '#666', lineHeight: 1.6 }}>
              <strong>Support:</strong> <a href="mailto:support@bareminimum.example.com" style={{ color: '#333', textDecoration: 'underline' }}>support@bareminimum.example.com</a><br/>
              <strong>Phone:</strong> 1-800-555-BARE<br/>
